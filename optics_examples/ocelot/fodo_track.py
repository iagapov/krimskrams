...
sf = Sextupole(l = 0.1, k2 = 2.0, id="sf")
sd = Sextupole(l = 0.1, k2 = -2.0, id="sd")
sf0 = Drift(l = 0.1)
sd0 = Drift(l = 0.1)


Q1 = Quadrupole (l = 0.293, k1 = 1.2)
Q2 = Quadrupole (l = 0.293, k1 = -1.2)

B1 = SBend(l = 2.0, angle = 0.04)
B2 = SBend(l = 1.227, angle = 0.04)

#fodo = (Q1, sf, D4, B1, D4, Q2, sd,  D4, B1, D4)
fodo = (Q1, d1, sf, d2, B1, d3, d4, Q2, d5, sd, d6, B1, d7)
...
for i in range(n):
    x, px = ellipse_from_twiss(15.e-3, tw0.beta_x, tw0.alpha_x)
